 ...
 */
final class Version20241229181657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page ADD parent_id INT NOT NULL, CHANGE short_name short_name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page DROP parent_id, CHANGE short_name short_name VARCHAR(255) NOT NULL');
    }
}
